...
productResult=multiply(productResult[0],c);
result.push(sumResult[0]);
result.push(productResult[0]);
var resultString=a+' and '+b+' and '+c+' sum to '+sumResult[0]+'.';
result.push(resultString);
resultString='The product of '+a+' and '+b+' and '+c+' is '+productResult[0]+'.';
result.push(resultString)
return(result);
}
...
var result=[];
result.push(testArray[0]+testArray[1]+testArray[2]);
result.push(testArray.join(',')+' was passed in as an array of numbers, and '+result[0]+' is their sum.');
return(result);
}
...
function multiplyArray(testArray){ //eslint-disable-line
  var result=[];
  result.push(testArray[0]*testArray[1]*testArray[2])
  result.push('The numbers '+testArray[0]+','+testArray[1]+','+testArray[2]+' have a product of '+result[0]+'.');
  return(result);
}
